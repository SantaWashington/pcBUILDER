...
public class HDD_Spawn : MonoBehaviour
{
    private GameObject savedObjectPrefab;
    private GameObject savedObjectInstance;
    public GameObject SpawnPoint;
    private Remember_HDD remember_hdd;

    private void Start()
    {
        remember_hdd = Remember_HDD.Instance;
        if (remember_hdd != null)
        {
            string savedObjectName = remember_hdd.GetSavedObjectState();
            if (!string.IsNullOrEmpty(savedObjectName))
            {
                ...
                GameObject[] objects7 = GameObject.FindGameObjectsWithTag("CPU");
                ...
                if (savedObjectPrefab != null)
                {
                    ...
                    remember_hdd.ClearSavedObjectState();
                    Remember_HDD.Instance.Reset();
                    GameObject[] objects2 = GameObject.FindGameObjectsWithTag("HDD_SSD");
