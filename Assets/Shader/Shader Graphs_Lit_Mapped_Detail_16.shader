Shader "Shader Graphs/Lit_Mapped_Detail" {
	Properties {
		...
		[ToggleUI] _EnableDetail ("Enable Detail", Float) = 1
		[NoScaleOffset] _DetailMap ("Detail Map", 2D) = "grey" {}
		_UVDetail ("Detail UV Channel", Range(0, 4)) = 0
		...
		[ToggleUI] _AlphaCutoffEnable ("AlphaCutoffEnable", Float) = 0
		[Toggle] _ALPHATEST ("ALPHATEST_ON", Float) = 0
